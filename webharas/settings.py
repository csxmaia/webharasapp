"""
Django settings for webharas project.
...
SECRET_KEY = 'django-insecure-+*ju(kv$@w^60m(&m==#o3_56tod9iy3xp#@@=q9g3o@@qkbwt'
...
WSGI_APPLICATION = 'webharas.wsgi.application'
